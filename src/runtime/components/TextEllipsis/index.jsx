...
const EllipsisText = ({ text, length, tooltip, ...other }) => {
  ...
  if (tooltip) {
    return (
      <Tooltip placement="topLeft" overlayStyle={{ wordBreak: 'break-all' }} title={text}>
        <span>
          {displayText}
          {tail}
        </span>
...
export default class Ellipsis extends Component {
  ...
  render() {
    ...
    if (isSupportLineClamp) {
      ...
      return (
        <Tooltip placement="topLeft" overlayStyle={{ wordBreak: 'break-all' }} title={tooltip ? children : ''}>
